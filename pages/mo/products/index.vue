<template>
  <div class="products">
    ...
    <div class="finish"><img src="https://files.myuwell.com/powehi/products/mo/finish.png" alt="finish" /></div>
  </div>
</template>
...
.products {
  ...
  .head-title {
    width: 100%;
    padding: (100 / @morem) 0 (58 / @morem) 0;
    text-align: center;
    .mfontSize(55);
  }
  .product-boxs {
